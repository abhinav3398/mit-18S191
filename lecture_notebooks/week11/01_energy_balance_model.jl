...
a = 5.0; # CO₂ forcing coefficient [W/m^2]

# ╔═╡ 91b1ff3a-179c-11eb-3fc1-2d991840a4a1
CO2_PI = 280.; # preindustrial CO₂ concentration [parts per million; ppm];
...
begin
	...
	plot!(xticks=[280, 280*2, 280*4, 280*8], legend=:bottomright)
...
We implement our custom `EBM` type as a `mutable struct` because we want to be able to modify the model's parameters in between different simulations, or even as time goes on in a single simulation.
